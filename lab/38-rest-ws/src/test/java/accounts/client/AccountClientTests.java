...
public class AccountClientTests {
	...
	public void addAndDeleteBeneficiary() {
		...
		URI beneficiaryUri = restTemplate.postForLocation(
			BASE_URL + "/accounts/{accountId}/beneficiaries",
			"David",
			 "1");
		
		// TODO-14: Retrieve the Beneficiary you just created from the location that was returned
		Beneficiary newBeneficiary = restTemplate.getForObject(beneficiaryUri, Beneficiary.class); // Modify this line to use the restTemplate
		...
		restTemplate.delete(
			BASE_URL + "/accounts/{accountId}/beneficiaries/{beneficiaryName}",
			"1",
			"David");
		...
		HttpClientErrorException httpClientErrorException = assertThrows(HttpClientErrorException.class, () -> {
			...
			//   was not successful.
			Beneficiary deletedBeneficiary = restTemplate.getForObject(beneficiaryUri, Beneficiary.class); // Modify this line to use the restTemplate
