...
public class AccountClientTests {
	...
	public void addAndDeleteBeneficiary() {
		...
		ResponseEntity<Beneficiary> deletedEntity = restTemplate.getForEntity(newBeneficiaryLocation, Beneficiary.class);
		assertThat(deletedEntity.getStatusCode()).isEqualTo(HttpStatus.NOT_FOUND);
	}
